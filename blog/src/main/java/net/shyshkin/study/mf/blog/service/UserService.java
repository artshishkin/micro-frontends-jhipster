...
import net.shyshkin.study.mf.blog.config.Constants;
import net.shyshkin.study.mf.blog.domain.Authority;
import net.shyshkin.study.mf.blog.domain.User;
import net.shyshkin.study.mf.blog.repository.AuthorityRepository;
import net.shyshkin.study.mf.blog.repository.UserRepository;
import net.shyshkin.study.mf.blog.security.SecurityUtils;
import net.shyshkin.study.mf.blog.service.dto.AdminUserDTO;
import net.shyshkin.study.mf.blog.service.dto.UserDTO;

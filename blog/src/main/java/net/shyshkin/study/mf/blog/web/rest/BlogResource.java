...
import net.shyshkin.study.mf.blog.repository.BlogRepository;
import net.shyshkin.study.mf.blog.repository.UserRepository;
import net.shyshkin.study.mf.blog.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link net.shyshkin.study.mf.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")

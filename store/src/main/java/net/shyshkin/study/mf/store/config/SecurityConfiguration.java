package net.shyshkin.study.mf.store.config;
...
import net.shyshkin.study.mf.store.security.oauth2.AudienceValidator;
import net.shyshkin.study.mf.store.security.oauth2.JwtGrantedAuthorityConverter;
import net.shyshkin.study.mf.store.web.filter.SpaWebFilter;

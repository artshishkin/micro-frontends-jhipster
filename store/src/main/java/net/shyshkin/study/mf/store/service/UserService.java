package net.shyshkin.study.mf.store.service;

import java.time.Instant;
import java.util.*;
import java.util.stream.Collectors;
import net.shyshkin.study.mf.store.config.Constants;
import net.shyshkin.study.mf.store.domain.Authority;
import net.shyshkin.study.mf.store.domain.User;
import net.shyshkin.study.mf.store.repository.AuthorityRepository;
import net.shyshkin.study.mf.store.repository.UserRepository;
import net.shyshkin.study.mf.store.security.SecurityUtils;
import net.shyshkin.study.mf.store.service.dto.AdminUserDTO;
import net.shyshkin.study.mf.store.service.dto.UserDTO;

...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("net.shyshkin.study.mf.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("net.shyshkin.study.mf.store.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}

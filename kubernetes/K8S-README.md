...
```
$ docker image tag gateway artarkatesoft/gateway
$ docker push artarkatesoft/gateway
$ docker image tag blog artarkatesoft/blog
$ docker push artarkatesoft/blog
$ docker image tag store artarkatesoft/store
$ docker push artarkatesoft/store
```
